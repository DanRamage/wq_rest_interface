        ...
        $('#map_canvas').gmap('addMarker', {
          ...
          var site_popup = '<div id="infoPopup" style="width:' + infoPopupWidth + 'px;height:' + infoPopupHeight + 'px;clear:both;white-space:nowrap;line-height:normal;"><strong>' + station.desc + '</strong>' +
                        ...
                        '<div style="float:left;padding-right:20px;padding-top:15px;">' +
                          '<div id="forecast" style="text-align:right">Forecast (' + new Date().getDate() + ' ' + month[new Date().getMonth()] + ')&nbsp;&nbsp;&nbsp;<span class="popup_label_' + forecast.toLowerCase().replace(' ', '') + '">' + capitalize(forecast) + '</span></div>' +
                        '</div>' +
                        '<div style="float:left;padding-top:15px;">' +
                          '<div id="advisory" style="text-align:right">Advisory&nbsp;&nbsp;&nbsp;<span class="' + get_advisory_style(station) + '">' + station.advisory.replace("<br />", " ") + '</span></div>' +
                        '</div><br style="clear:both">' +
                        '<div style="float:left;padding-right:20px;padding-top:15px;">' +
                          '<div id="sample_data" style="text-align:right">Bacteria Data' + dateIcon + '&nbsp;&nbsp;&nbsp;<span class="' + get_bacteria_style(station, data) +'">' + data + '</span></div>' +
                        '</div>' +
