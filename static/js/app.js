...
if(onlineStatus != 'off'){
  ...
  $.ajax({
      ...
      crossDomain: false,
      timeout: 5000,
      //url: "http://howsthebeach.org/ba-simple-proxy.php?url=http://129.252.139.124/mapping/xenia/feeds/florida_wq/monitorstations/beachAdvisoryResults.json",
      //url: "http://dev.howsthebeach.org/rest/sarasota/sample_data/current_results",
  ...
  legendContentHtml['forecast'] = '<div><p><strong>Today\'s forecasted conditions</strong></p><div style="float:left;padding-right:10px;"><img src="images/none_marker.png" /> No forecast available<br /><img src="images/low_marker.png" /> Low bacteria level</div><div style="float:left"><img src="images/medium_marker.png" /> Medium bacteria level<br /><img src="images/high_marker.png" /> High bacteria level</div><br style="clear:both"><a class="ui-btn ui-btn-corner-all ui-mini ui-btn-up-c" data-theme="c" data-wrapperels="span" data-corners="true" href="#moreInformation" data-role="button" data-mini="true" style="padding:0.4em 1em;"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">More Info</span></span></a></div>';
  legendContentHtml['advisories'] = '<div><p><strong>Swim advisories</strong></p><p><img src="images/low_marker.png" /> None: no swimming advisory issued - safe to swim.<br /><img src="images/high_marker.png" /> Yes: an advisory is current - swimming not recommended.</p><a class="ui-btn ui-btn-corner-all ui-mini ui-btn-up-c" data-theme="c" data-wrapperels="span" data-corners="true" href="#moreInformation" data-role="button" data-mini="true" style="padding:0.4em 1em;"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">More Info</span></span></a></div>';
  legendContentHtml['data'] = '<div><p><strong>Bacteria level data</strong></p><div style="float:left;padding-right:10px;"><img src="images/none_marker.png" /> No data available<br /><img src="images/low_marker.png" /> Low bacteria level</div><div style="float:left"><img src="images/medium_marker.png" /> Medium bacteria level<br /><img src="images/high_marker.png" /> High bacteria level</div><br style="clear:both"><a class="ui-btn ui-btn-corner-all ui-mini ui-btn-up-c" data-theme="c" data-wrapperels="span" data-corners="true" href="#moreInformation" data-role="button" data-mini="true" style="padding:0.4em 1em;"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">More Info</span></span></a></div>';
  ...
  $('#mapPage').bind('pageinit', function(event) {
    ...
    var site_info_url = '/sites/' + site + '/info.html';
  ...
  */
  ...
  $('#beachDetailsPage').bind('pageinit', function(event) {
    ...
    if(typeof currentEtcoc[$.mobile.pageData.id].date === "undefined"){
